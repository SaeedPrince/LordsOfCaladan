...
#include "BastudioStrategyCameraComponent.generated.h"

UCLASS(Blueprintable, ClassGroup = Camera, meta = (BlueprintSpawnableComponent))
class LORDSOFCALADAN_API UBastudioStrategyCameraComponent : public USceneComponent
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UBastudioStrategyCameraComponent();
